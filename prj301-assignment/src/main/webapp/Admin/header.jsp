                ...
                <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
                    <div class="u-inner-container-layout u-sidenav-overflow">
                        ...
                        <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="<%= request.getContextPath()%>/Admin/home.jsp" style="padding: 10px 26px;" title="Home">HOME</a>
                            </li>
                            ...
                            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="<%= request.getContextPath()%>/OrderController/list" rel="nofollow" style="padding: 10px 26px;">FINANCE</a>
                            </li>
                            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="<%= request.getContextPath()%>/UserController/listUser" rel="nofollow" style="padding: 10px 26px;">USER</a>
                            </li>
                            ...
                            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="<%= request.getContextPath()%>/UserController/logout" rel="nofollow" style="padding: 10px 26px;">LOGOUT <i class="fa-solid fa-right-from-bracket"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
