<%-- 
    Document   : loginUser
    Created on : Mar 4, 2022, 10:55:03 PM
    Author     : 84378
--%>
...
<html style="font-size: 16px;">
    ...
    <body class="u-body u-xl-mode">
        ...
        <!--        <header class="u-clearfix u-header u-valign-middle u-header" id="sec-e70b"><a href="https://nicepage.com/c/sports-website-templates" class="u-image u-logo u-image-1" data-image-width="242" data-image-height="111">
                        ...
                        <div class="u-custom-menu u-nav-container">
                            <ul class="u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="/prj301-assignment/User/home.jsp" style="padding: 22px 26px;">Home</a>
                                </li><% if (session.getAttribute("usersession") == null) { %><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="/prj301-assignment/User/login.jsp" style="padding: 22px 26px;">Contact</a>
                                </li><% } else { %><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="/prj301-assignment/User/contact.jsp" style="padding: 22px 26px;">Contact</a>
        ...
        <section class="u-align-center u-clearfix u-palette-2-light-3 u-section-1" id="sec-df7b" style="padding-bottom: 1% ">
            <div class="u-align-left u-clearfix u-sheet u-sheet-1">
                <h2 class="u-text u-text-default u-text-1">Admin Login</h2>
                <div class="u-form u-form-1">
                    <form action="<%= request.getContextPath()%>/UserController/loginAdmin" method="GET" style="padding: 15px;" source="custom">
                        <div class="u-form-group u-form-name ">
                            Name<input type="text" id="name-ef64" name="username" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="" placeholder="Name">
                        </div>
                        ...
                        <div style="color: red">
                            <%
                                if (request.getAttribute("login-msg") != null && !request.getAttribute("login-msg").equals("")) {
                                    out.print(request.getAttribute("login-msg"));
                                }
                            %>
                        </div>
                ...
                <p></p>
                <a href="/prj301-assignment/User/login.jsp" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-btn-2">User</a>
                <h3 class="u-text u-text-default u-text-2">You are user ?</h3>
                <p></p>
            </div>
        </section>
