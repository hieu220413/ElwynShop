<%-- 
    Document   : userInfo
    Created on : Mar 17, 2022, 6:23:23 PM
    Author     : Acer.Lucas
--%>
        ...
        <c:set var="userDetail" value="${requestScope.user}"></c:set>
            ...
            <div class="container">
                <div class="card">
                    ...
                    <div class="forms">
                        <div class="inputs"> <span>ID</span> ${userDetail.userId}</div>
                        <input type="hidden" name="userID" value="${userDetail.userId}">
                        <div class="inputs"> <span>Username</span> ${userDetail.username}</div>
                        <input type="hidden" name="username" value="${userDetail.username}">
                        <div class="inputs"> <span>Password</span> ${userDetail.password} </div>
                        <input type="hidden" name="password" value="${userDetail.password}">
                        <div class="inputs"> <span>Name</span> ${userDetail.name}</div>
                        <input type="hidden" name="name" value="${userDetail.name}">
                        <div class="inputs"> <span>Email</span> ${userDetail.email} </div>
                        <input type="hidden" name="email" value="${userDetail.email}">
                        <div class="inputs"> <span>Phone</span> ${userDetail.phone} </div>
