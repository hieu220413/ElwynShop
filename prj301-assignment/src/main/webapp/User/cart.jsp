...
<body class="u-body u-xl-mode" style="height: auto; min-height: 100%;">
    <header class="u-clearfix u-header u-valign-middle u-header" id="sec-e70b">
        <a href="/prj301-assignment/User/home.jsp" class="u-image u-logo u-image-1" data-image-width="242" data-image-height="111">
    ...
    <section class="u-clearfix u-palette-2-light-3 u-section-1" id="sec-dbee">
        <div class="u-clearfix u-sheet u-sheet-1">
            ...
            <c:if test="${not empty sessionScope.Cart}" >
                ...
                <c:forEach var="cart" items="${sessionScope.Cart}">
                    ...
                    <h3 class="u-custom-font u-font-lobster u-text u-text-default u-text-4">Units:</h3><span style="width:70px;" class="u-file-icon u-icon u-icon-2"><a href="<%=request.getContextPath()%>/CartController/removecart?id=${cart.key}"><i class="fa-solid fa-trash"></i></a></span>
            ...
            <c:if test="${empty sessionScope.Cart}">
                ...
                <c:if test="${requestScope.AlreadyPay != null}">
            ...
            <!-- Phan link -->
            <form action="<%=request.getContextPath()%>/CartController/pay" style="padding-left: 300px;margin-top: 5% ">
