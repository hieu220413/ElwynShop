...
<body class="u-body u-xl-mode"><header class="u-clearfix u-header u-valign-middle u-header" id="sec-e70b"><a href="https://nicepage.com/c/sports-website-templates" class="u-image u-logo u-image-1" data-image-width="242" data-image-height="111">
            ...
            <div class="u-custom-menu u-nav-container">
                <ul class="u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="/prj301-assignment/User/home.jsp" style="padding: 22px 26px;"><i class="fa-solid fa-house"></i></a>
                    ...
                    </li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="${pageContext.request.contextPath}/UserController/logout" style="padding: 22px 26px;"><i class="fa-solid fa-right-from-bracket"></i></a>
                    </li>
                    <% }%></ul>
            </div>
        ...
        <section class="u-clearfix u-palette-2-light-3" style="text-align: center"><h2 class="u-text u-text-1" style="font-weight: bold;">Edit your password<span style="font-weight: 700;"></span> </h2>
        <h4 class="u-text u-text-2">Fill all the blank to cover your account</h4></section>
        <section class="u-clearfix u-palette-2-light-3 u-section-1" style="height: 500px" id="sec-8e09">

        <div class="u-clearfix u-sheet u-sheet-1" style="right: 195px;">
            <div class="u-form u-form-1">
                <form action="<%= request.getContextPath()%>/UserController/editPassword" method="GET"  style="padding: 10px;">
                    ...
                    <div class="u-form-group u-form-group-4">
                        <label for="text-7b81" class="u-label">Password</label>
                        <input type="text" placeholder="Your password" id="text-7b81" name="Oldpassword" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                    </div>
                    <div class="u-form-group u-form-group-5">
                        <label for="text-72ad" class="u-label">New Password</label>
                        <input type="text" placeholder="Your new password" id="text-72ad" name="password" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                    </div>
                    <div class="u-form-group u-form-group-6">
                        <label for="text-739e" class="u-label">Confirm password</label>
                        <input type="text" placeholder="Your new password" id="text-739e" name="repassword" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                    </div>
                    <div style="color: red">
                        <%
                            if (request.getAttribute("edit-msg6") != null && !request.getAttribute("edit-msg6").equals("")) {
                                out.print(request.getAttribute("edit-msg6"));
                            } else if (request.getAttribute("edit-msg7") != null && !request.getAttribute("edit-msg7").equals("")) {
                                out.print(request.getAttribute("edit-msg7"));
                            } else if (request.getAttribute("edit-msg8") != null && !request.getAttribute("edit-msg8").equals("")) {
                                out.print(request.getAttribute("edit-msg8"));
                            }
                        %>
                    </div>
