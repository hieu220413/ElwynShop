            ...
            <div class="u-border-1 u-border-palette-1-light-1 u-btn u-btn-round u-button-style u-palette-1-light-3 u-radius-3 u-text-palette-1-dark-2 u-btn-1" style="background-color:#fbeced ;box-shadow: none;" >
                <div class="dropdown" >
                    ...
                    <div id="myDropdown" class="dropdown-content">
                        <a href="<%=request.getContextPath()%>/ProductController/listMenPriceOder">Decreasing price</a>

                        <a href="<%=request.getContextPath()%>/ProductController/listMenDateOder">Most recently date</a>
                ...
                <c:forEach var="list" items="${list}">   
                    ...
                    <div class="col-4" >
                        <div class="u-repeater u-repeater-1" style="padding-top:10%">
                            ...
                            <a href="<%=request.getContextPath()%>/ProductController/productdetail?id=${list.productID}&group=men">
