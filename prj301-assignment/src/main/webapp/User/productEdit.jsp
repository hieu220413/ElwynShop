            ...
            <div class="u-clearfix u-sheet u-valign-middle u-sheet-1"><!--product--><!--product_options_json--><!--{"source":""}--><!--/product_options_json--><!--product_item-->
                <div class="u-container-style u-expanded-width u-product u-product-1">
                    <div class="u-container-layout u-container-layout-1">
                        <h2 class="u-text u-text-default u-text-1 ">Edit Product</h2>
                        <div class="u-form u-form-1">
                            <form action="#" method="POST" class="u-clearfix u-form-spacing-12 u-form-vertical u-inner-form" style="padding: 9px;" source="email" name="form">
                                ...
                                <div class="u-form-email u-form-group u-label-left">
                                    ...
                                    <input type="email" placeholder="Enter product price" id="email-3b9a" name="price" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                                </div>
                                <div class="u-form-group u-form-select u-label-left u-form-group-3">
                                    <label for="select-b7db" class="u-label">Category</label>
                                    <div class="u-form-select-wrapper">
                                        <select id="select-b7db" name="select" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
                                ...
                                <div class="u-form-group u-form-message u-label-left">
                                    <label for="message-3b9a" class="u-label">Description</label>
                                    <textarea placeholder="Enter description" rows="4" cols="50" id="message-3b9a" name="description" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required=""></textarea>
                                </div>
                        ...
                        <img class="u-image u-image-default u-image-1" src="../images/-min.jpg" alt="" data-image-width="1600" data-image-height="1067">
                        <a href="https://nicepage.site" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-6 u-btn-2">Change image</a>
                    </div>
