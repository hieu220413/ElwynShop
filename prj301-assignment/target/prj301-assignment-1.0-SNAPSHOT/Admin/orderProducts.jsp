                            ...
                            <div class="u-align-center u-container-style u-shape-rectangle u-tab-active u-tab-pane u-tab-pane-2" id="tab-0da5" role="tabpanel" aria-labelledby="link-tab-0da5">
                                <div class="u-container-layout u-container-layout-2">
                                    <div class="u-expanded-width u-table u-table-responsive u-table-4">
                                        <h3>Products list of order ${orderId} </h3>
                                ...
                                <a style="margin-top: 2%;" href="<%= request.getContextPath()%>/OrderController/list" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-btn-8" style="margin-top: 0px">Back</a>            
                            </div>
                        </div>
                    </div>
                </div>
