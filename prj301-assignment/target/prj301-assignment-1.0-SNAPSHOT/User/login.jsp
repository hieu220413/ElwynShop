    ...
    <section class="u-align-center u-clearfix u-palette-2-light-3 u-section-1" id="sec-df7b" style="padding-bottom: 1% ">
        <div class="u-align-left u-clearfix u-sheet u-sheet-1">
            ...
            <div class="u-form u-form-1">
                <form action="<%= request.getContextPath()%>/UserController/login" method="GET" style="padding: 15px;" source="custom">
                    <div class="u-form-group u-form-name ">
                        Username<input type="text" id="name-ef64" name="username" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="" placeholder="Name">
                    </div>
            ...
            <a href="/prj301-assignment/User/signin.jsp" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-btn-2">Create</a>
            <h3 class="u-text u-text-default u-text-2">You don't have an account ?</h3>
            <p></p>
            <a href="/prj301-assignment/Admin/login.jsp" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-btn-2">Admin</a>
            <h3 class="u-text u-text-default u-text-2">You are admin ?</h3>
            <p></p>
        </div>
    </section>
