...
<html style="font-size: 16px;">
    ...
    <style>
        ...
        .text {
            ...
            background-image: linear-gradient(to bottom,rgb(159 150 150 / 20%), white);
        }
                    ...
                    <div class="container row">
                        ...
                        <c:forEach var="search" items="${requestScope.list}">
                            ...
                            <div class="col-4" >
                                    ...
                                    <a href="<%=request.getContextPath()%>/ProductController/productdetail?id=${search.productID}">
                                        <div class="u-container-style u-list-item u-repeater-item">
                                            <div class="u-container-layout u-similar-container u-container-layout-1">
                                                ...
                                                <div style="width: 350px; height: 500px" onmouseout="imgdetailoff${search.productID}()" onmouseover="imgdetail${search.productID}()">
                                                    <img  alt="Avatar" class="image" style="width: 100%; height: 100%"  src="${search.imagesPath}" data-image-width="350" data-image-height="1025">
                                ...
                                <h2 class="u-custom-font u-font-lobster u-text u-text-default u-text-2">${search.name}&nbsp;</h2>
